...
# 1. DANH SÁCH MÃ CỔ PHIẾU (15 mã Bất động sản - Xây dựng)
...
SOURCE_INFO: list[dict] = [
    ...
    {"name": "Tuổi Trẻ", "domain": "tuoitre.vn", "categories": "Kinh tế", "type": "RSS", "rss": "Có", "articles": "10k+", "note": "Tin kinh tế, bất động sản hàng ngày", "has_rss": True, "has_api": False},
...
# 6b. DANH SÁCH SITEMAP (Cách 1)
SITEMAP_SOURCES: list[dict] = [
...
XLXS_PATH = r"data\CRAWL_NHOM_BDS_XAYDUNG.xlsx"
