...
var README_ROWS = [
  ["group_id", "Nhóm 4"],
  ["group_name", "Bất động sản - Xây dựng"],
  ...
  ["data_sources", "15 nguồn tin: CafeF, CafeBiz, VnExpress, VietnamNet, VnEconomy, VnBusiness, Dân trí, Doanh nghiệp VN, Sức Khỏe & Đời Sống, ZNEWS, Soha, Đầu Tư VN, Đời Sống VN, Tuổi Trẻ, Thanh Niên"],
  ["crawl_method", "RSS (21 feeds) + API (3 zones) - UrlFetchApp.fetchAll batching"],
  ...
  ["sheets_description", "COMPANY_INFO: 15 companies | SOURCE_LIST: 15 sources | SOURCE_INDEX: Danh sách links (6 cols) | NEWS_RAW: Dữ liệu bài viết chi tiết (18 cols) | CONFIG_SOURCES: Cấu hình 15 nguồn | CONFIG_KEYWORDS: Cấu hình từ khóa | CRAWL_LOG: Crawl history | DAILY_SUMMARY: Progress | DATA_QUALITY_CHECK: Quality | README: This sheet"],
  ["news_raw_columns", "news_id, title, summary, content, published_date, source, url, industry_group, tickers, keywords, event_type, crawl_time, content_hash, crawl_status, error_message, checked_by, checked_time, note"],
  ...
  ["note", "Bộ dữ liệu tài chính phục vụ đồ án thu thập và phân tích dữ liệu chuyên ngành Khoa học dữ liệu, Khoa Kỹ thuật và Công nghệ - Đại học Huế."]
];
